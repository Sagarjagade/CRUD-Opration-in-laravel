...
<br><br>
	<div class="row">
			...
			<div class="col-md-6">
				<center style="font-size:30px;"><b><i>Add Employee Details</i></b></center>
			</div>
...
<br><Br>
	...
	<div class="row">
		...
		<div class="col-md-8">
			<form action="<?php echo e(route('createlist.store')); ?>" method="post">
				<?php echo csrf_field(); ?>
				<div class="form-group">
					<label style="color: green"><b>First Name </b>: </label>
					<input type="text" class="form-control <?php echo e(($errors->any && $errors->first('firstname') ? 'is-invalid' : '' )); ?>" value="<?php echo e(old('firstname')); ?>" name="firstname">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control <?php echo e(($errors->any && $errors->first('lastname') ? 'is-invalid' : '' )); ?>" value="<?php echo e(old('lastname')); ?>" name="lastname">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control <?php echo e(($errors->any && $errors->first('mobilenumber') ? 'is-invalid' : '' )); ?>" value="<?php echo e(old('mobilenumber')); ?>" name="mobilenumber">
				...
				<div class="form-group">
					...
					<textarea class="form-control <?php echo e(($errors->any && $errors->first('description') ? 'is-invalid' : '' )); ?>" value="" name="description"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('CRUD.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Prashant Jagade\Desktop\Laravel\Project\blog\resources\views/CRUD/show.blade.php ENDPATH**/ ?>